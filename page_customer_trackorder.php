...
if($self == 'page_customer_trackorder'){
							...
							<div class="card bottom-left shadow-showcase">
								...
								<div class="card-body">
									...
									<div class="list-group">
										<?php 
												$sql = "SELECT DISTINCT(A.track_no) AS t_no, C.payment_status,
													...
													LEFT JOIN tbl_delivery AS C ON (A.`track_no` = C.`track_no`)
													WHERE B.cust_ID = '$admin_id' AND A.trans_status='0'
													ORDER BY A.`id` DESC";
										...
										?>
												<a href="page_customer_trackorder.php?trackno=<?= $t_no; ?>&msg=no" class="list-group-item list-group-item-action <?php if($_GET['trackno'] == $t_no){echo "active";}else{echo "";}?>">
